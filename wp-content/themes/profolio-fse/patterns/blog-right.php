...
<h1 class="wp-block-heading has-text-align-center"><?php echo esc_html__( 'News Right Sidebar', 'profolio-fse' ); ?></h1>
<!-- /wp:heading --></div></div>
<!-- /wp:cover -->
...
<main class="wp-block-group r-pad" style="margin-top:0px;margin-bottom:0px;padding-top:80px;padding-right:20px;padding-bottom:80px;padding-left:20px"><!-- wp:columns {"style":{"spacing":{"blockGap":{"top":"40px","left":"40px"}}}} -->
