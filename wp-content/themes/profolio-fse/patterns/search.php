...
<div class="wp-block-cover" style="margin-top:0;margin-bottom:0;min-height:250px"><img class="wp-block-cover__image-background wp-image-807" alt="" src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/banner.jpg" data-object-fit="cover"/><span aria-hidden="true" class="wp-block-cover__background has-black-background-color has-background-dim-80 has-background-dim"></span><div class="wp-block-cover__inner-container"><!-- wp:query-title {"type":"search","textAlign":"center","showSearchTerm":false,"fontSize":"x-large"} /--></div></div>
<!-- /wp:cover -->

<!-- wp:group {"tagName":"main","className":"r-pad","style":{"spacing":{"margin":{"top":"1px","bottom":"1px"},"padding":{"right":"20px","left":"20px","top":"80px","bottom":"80px"}}},"layout":{"type":"constrained"}} -->
<main class="wp-block-group r-pad" style="margin-top:1px;margin-bottom:1px;padding-top:80px;padding-right:20px;padding-bottom:80px;padding-left:20px"><!-- wp:columns {"style":{"spacing":{"blockGap":{"top":"40px","left":"40px"}}}} -->
