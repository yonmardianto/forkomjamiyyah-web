<?php
 /**
  * Title: Sidebar Shop
  * Slug: business-enterprise/sidebar-shop
  * Categories: theme
  */
?>
...
<h3 class="wp-block-heading has-text-align-left has-body-color has-text-color has-large-font-size" style="margin-bottom:var(--wp--preset--spacing--small)"><?php echo esc_html__( 'Product Search', 'business-enterprise' ); ?></h3>
<!-- /wp:heading -->
...
<div class="wp-block-group is-style-bk-box-shadow has-pure-white-background-color has-background" style="border-radius:6px;padding-top:var(--wp--preset--spacing--medium);padding-right:var(--wp--preset--spacing--medium);padding-bottom:var(--wp--preset--spacing--medium);padding-left:var(--wp--preset--spacing--medium)"><!-- wp:heading {"textAlign":"left","level":3,"style":{"spacing":{"margin":{"bottom":"var:preset|spacing|small"}}},"textColor":"body","fontSize":"large"} -->
<h3 class="wp-block-heading has-text-align-left has-body-color has-text-color has-large-font-size" style="margin-bottom:var(--wp--preset--spacing--small)"><?php echo esc_html__( 'Product Categories', 'business-enterprise' ); ?></h3>
<!-- /wp:heading -->
...
<h3 class="wp-block-heading has-large-font-size"><?php echo esc_html__( 'Filter by pric', 'business-enterprise' ); ?>e</h3>
<!-- /wp:heading -->
...
<!-- wp:group {"style":{"spacing":{"padding":{"top":"var:preset|spacing|medium","right":"var:preset|spacing|medium","bottom":"var:preset|spacing|medium","left":"var:preset|spacing|medium"}},"border":{"radius":"6px"}},"backgroundColor":"pure-white","className":"is-style-bk-box-shadow"} -->
<div class="wp-block-group is-style-bk-box-shadow has-pure-white-background-color has-background" style="border-radius:6px;padding-top:var(--wp--preset--spacing--medium);padding-right:var(--wp--preset--spacing--medium);padding-bottom:var(--wp--preset--spacing--medium);padding-left:var(--wp--preset--spacing--medium)"><!-- wp:heading {"textAlign":"left","level":3,"style":{"spacing":{"margin":{"bottom":"var:preset|spacing|small"}}},"textColor":"body","fontSize":"large"} -->
<h3 class="wp-block-heading has-text-align-left has-body-color has-text-color has-large-font-size" style="margin-bottom:var(--wp--preset--spacing--small)"><?php echo esc_html__( 'Recent Products', 'business-enterprise' ); ?></h3>
<!-- /wp:heading -->
