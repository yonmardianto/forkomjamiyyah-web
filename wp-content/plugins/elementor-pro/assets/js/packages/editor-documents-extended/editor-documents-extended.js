...
/***/ "./packages/packages/pro/editor-documents-extended/src/extensions/display-conditions/hooks/use-active-document-extended.ts":
/*!*********************************************************************************************************************************!*\
  !*** ./packages/packages/pro/editor-documents-extended/src/extensions/display-conditions/hooks/use-active-document-extended.ts ***!
  \*********************************************************************************************************************************/
...
/* harmony export */   "default": function() { return /* binding */ useActiveDocumentExtended; }
/* harmony export */ });
...
function useActiveDocumentExtended() {
  ...
  const documentExtensions = (0,_elementor_store__WEBPACK_IMPORTED_MODULE_1__.__useSelector)(state => {
    if (!document) {
      return null;
    }
...
/***/ "./packages/packages/pro/editor-documents-extended/src/extensions/display-conditions/hooks/use-document-display-conditions-props.ts":
/*!******************************************************************************************************************************************!*\
  !*** ./packages/packages/pro/editor-documents-extended/src/extensions/display-conditions/hooks/use-document-display-conditions-props.ts ***!
  \******************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": function() { return /* binding */ useDocumentDisplayConditionsProps; }
/* harmony export */ });
...
/* harmony import */ var _icons__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../icons */ "./packages/packages/pro/editor-documents-extended/src/icons/index.ts");
/* harmony import */ var _use_active_document_extended__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./use-active-document-extended */ "./packages/packages/pro/editor-documents-extended/src/extensions/display-conditions/hooks/use-active-document-extended.ts");




function useDocumentDisplayConditionsProps() {
  const document = (0,_use_active_document_extended__WEBPACK_IMPORTED_MODULE_3__["default"])();
  const visible = !!document?.locationKey;
  return {
    icon: _icons__WEBPACK_IMPORTED_MODULE_2__.HierarchyIcon,
    title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Display Conditions', 'elementor-pro'),
    visible,
    onClick: () => {
      (0,_elementor_editor_v1_adapters__WEBPACK_IMPORTED_MODULE_0__.__privateOpenRoute)('theme-builder-publish/conditions');
    }
  };
}
...
/***/ "./packages/packages/pro/editor-documents-extended/src/extensions/display-conditions/index.ts":
/*!****************************************************************************************************!*\
  !*** ./packages/packages/pro/editor-documents-extended/src/extensions/display-conditions/index.ts ***!
  \****************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _hooks_use_document_display_conditions_props__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./hooks/use-document-display-conditions-props */ "./packages/packages/pro/editor-documents-extended/src/extensions/display-conditions/hooks/use-document-display-conditions-props.ts");


function init() {
  _elementor_editor_app_bar__WEBPACK_IMPORTED_MODULE_0__.documentOptionsMenu.registerAction({
    id: 'document-display-conditions',
    priority: 10,
    // Before popup triggers.
    useProps: _hooks_use_document_display_conditions_props__WEBPACK_IMPORTED_MODULE_1__["default"]
  });
}

/***/ }),

/***/ "./packages/packages/pro/editor-documents-extended/src/extensions/index.ts":
/*!*********************************************************************************!*\
  !*** ./packages/packages/pro/editor-documents-extended/src/extensions/index.ts ***!
  \*********************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony export */   init: function() { return /* binding */ init; }
/* harmony export */ });
/* harmony import */ var _display_conditions__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./display-conditions */ "./packages/packages/pro/editor-documents-extended/src/extensions/display-conditions/index.ts");
/* harmony import */ var _popups__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./popups */ "./packages/packages/pro/editor-documents-extended/src/extensions/popups/index.ts");


function init() {
  (0,_popups__WEBPACK_IMPORTED_MODULE_1__.init)();
  (0,_display_conditions__WEBPACK_IMPORTED_MODULE_0__.init)();
}

/***/ }),

/***/ "./packages/packages/pro/editor-documents-extended/src/extensions/popups/hooks/use-popup-advanced-rules-props.ts":
/*!***********************************************************************************************************************!*\
  !*** ./packages/packages/pro/editor-documents-extended/src/extensions/popups/hooks/use-popup-advanced-rules-props.ts ***!
  \***********************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": function() { return /* binding */ usePopupAdvancedRulesProps; }
/* harmony export */ });
/* harmony import */ var _elementor_editor_documents__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @elementor/editor-documents */ "@elementor/editor-documents");
/* harmony import */ var _elementor_editor_documents__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_elementor_editor_documents__WEBPACK_IMPORTED_MODULE_0__);
...
function usePopupAdvancedRulesProps() {
  ...
  return {
    icon: _elementor_icons__WEBPACK_IMPORTED_MODULE_2__.SettingsIcon,
...
/***/ "./packages/packages/pro/editor-documents-extended/src/extensions/popups/hooks/use-popup-triggers-props.ts":
/*!*****************************************************************************************************************!*\
  !*** ./packages/packages/pro/editor-documents-extended/src/extensions/popups/hooks/use-popup-triggers-props.ts ***!
  \*****************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": function() { return /* binding */ usePopupTriggersProps; }
/* harmony export */ });
/* harmony import */ var _elementor_editor_documents__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @elementor/editor-documents */ "@elementor/editor-documents");
/* harmony import */ var _elementor_editor_documents__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_elementor_editor_documents__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _elementor_editor_v1_adapters__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @elementor/editor-v1-adapters */ "@elementor/editor-v1-adapters");
...
/* harmony import */ var _icons__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../icons */ "./packages/packages/pro/editor-documents-extended/src/icons/index.ts");
...
function usePopupTriggersProps() {
  ...
  const visible = 'popup' === document?.type.value;
  return {
    icon: _icons__WEBPACK_IMPORTED_MODULE_3__.TriggerIcon,
    title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)('Triggers', 'elementor-pro'),
    visible,
    onClick: () => {
...
/***/ "./packages/packages/pro/editor-documents-extended/src/extensions/popups/index.ts":
/*!****************************************************************************************!*\
  !*** ./packages/packages/pro/editor-documents-extended/src/extensions/popups/index.ts ***!
  \****************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _elementor_editor_app_bar__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @elementor/editor-app-bar */ "@elementor/editor-app-bar");
/* harmony import */ var _elementor_editor_app_bar__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_elementor_editor_app_bar__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _hooks_use_popup_advanced_rules_props__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./hooks/use-popup-advanced-rules-props */ "./packages/packages/pro/editor-documents-extended/src/extensions/popups/hooks/use-popup-advanced-rules-props.ts");
/* harmony import */ var _hooks_use_popup_triggers_props__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./hooks/use-popup-triggers-props */ "./packages/packages/pro/editor-documents-extended/src/extensions/popups/hooks/use-popup-triggers-props.ts");
...
function init() {
  _elementor_editor_app_bar__WEBPACK_IMPORTED_MODULE_0__.documentOptionsMenu.registerAction({
    ...
    useProps: _hooks_use_popup_triggers_props__WEBPACK_IMPORTED_MODULE_2__["default"]
  });
  _elementor_editor_app_bar__WEBPACK_IMPORTED_MODULE_0__.documentOptionsMenu.registerAction({
    id: 'popup-advanced-rules',
    priority: 30,
    // After popup triggers.
    useProps: _hooks_use_popup_advanced_rules_props__WEBPACK_IMPORTED_MODULE_1__["default"]
  });
}
...
const HierarchyIcon = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.forwardRef((props, ref) => {
...
/* harmony default export */ __webpack_exports__["default"] = (HierarchyIcon);

/***/ }),

/***/ "./packages/packages/pro/editor-documents-extended/src/icons/index.ts":
/*!****************************************************************************!*\
  !*** ./packages/packages/pro/editor-documents-extended/src/icons/index.ts ***!
  \****************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   HierarchyIcon: function() { return /* reexport safe */ _hierarchy_icon__WEBPACK_IMPORTED_MODULE_0__["default"]; },
/* harmony export */   TriggerIcon: function() { return /* reexport safe */ _trigger_icon__WEBPACK_IMPORTED_MODULE_1__["default"]; }
/* harmony export */ });
/* harmony import */ var _hierarchy_icon__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./hierarchy-icon */ "./packages/packages/pro/editor-documents-extended/src/icons/hierarchy-icon.tsx");
/* harmony import */ var _trigger_icon__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./trigger-icon */ "./packages/packages/pro/editor-documents-extended/src/icons/trigger-icon.tsx");



/***/ }),

/***/ "./packages/packages/pro/editor-documents-extended/src/icons/trigger-icon.tsx":
/*!************************************************************************************!*\
  !*** ./packages/packages/pro/editor-documents-extended/src/icons/trigger-icon.tsx ***!
  \************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
const TriggerIcon = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.forwardRef((props, ref) => {
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_elementor_ui__WEBPACK_IMPORTED_MODULE_1__.SvgIcon, _extends({
    viewBox: "0 0 24 24"
  }, props, {
    ref: ref
...
/* harmony default export */ __webpack_exports__["default"] = (TriggerIcon);

/***/ }),

/***/ "./packages/packages/pro/editor-documents-extended/src/init.ts":
/*!*********************************************************************!*\
  !*** ./packages/packages/pro/editor-documents-extended/src/init.ts ***!
  \*********************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./packages/packages/pro/editor-documents-extended/src/store/index.ts":
/*!****************************************************************************!*\
  !*** ./packages/packages/pro/editor-documents-extended/src/store/index.ts ***!
  \****************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./packages/packages/pro/editor-documents-extended/src/sync/index.ts":
/*!***************************************************************************!*\
  !*** ./packages/packages/pro/editor-documents-extended/src/sync/index.ts ***!
  \***************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony export */ });
/* harmony import */ var _sync_store__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./sync-store */ "./packages/packages/pro/editor-documents-extended/src/sync/sync-store.ts");


/***/ }),

/***/ "./packages/packages/pro/editor-documents-extended/src/sync/sync-store.ts":
/*!********************************************************************************!*\
  !*** ./packages/packages/pro/editor-documents-extended/src/sync/sync-store.ts ***!
  \********************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
function syncInitialization() {
  const {
    init
  } = _store__WEBPACK_IMPORTED_MODULE_2__.slice.actions;
...
function syncOnDocumentOpen() {
  ...
  (0,_elementor_editor_v1_adapters__WEBPACK_IMPORTED_MODULE_0__.__privateListenTo)((0,_elementor_editor_v1_adapters__WEBPACK_IMPORTED_MODULE_0__.commandEndEvent)('editor/documents/open'), () => {
    ...
    (0,_elementor_store__WEBPACK_IMPORTED_MODULE_1__.__dispatch)(addDocument(currentDocument));
  });
}
...
/***/ "./packages/packages/pro/editor-documents-extended/src/types.ts":
/*!**********************************************************************!*\
  !*** ./packages/packages/pro/editor-documents-extended/src/types.ts ***!
  \**********************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony export */ });
/* harmony import */ var _init__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./init */ "./packages/packages/pro/editor-documents-extended/src/init.ts");
/* harmony import */ var _types__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./types */ "./packages/packages/pro/editor-documents-extended/src/types.ts");
