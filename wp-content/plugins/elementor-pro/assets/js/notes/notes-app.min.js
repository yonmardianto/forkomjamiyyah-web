"use strict";(self.webpackChunkelementor_pro_notes=self.webpackChunkelementor_pro_notes||[]).push([[716],{7622(e,t,n){n.d(t,{default:()=>Ua});var r=n(1594),o=n.n(r),a=n(5826);const i=a.Ay.button`
	all: revert;
...
`;function Rt(e){return 0===e.readers.length?null:o().createElement(Y,{delayDuration:400},o().createElement(Y.Trigger,{asChild:!0},o().createElement(Ct,{className:"eicon-preview-medium",tabIndex:0})),o().createElement(kt,null,o().createElement("strong",null,Et("Seen by","elementor-pro")+": "),e.readers.map(e=>e.name).join(", "),o().createElement(Y.Arrow,null)))}Rt.propTypes={readers:At.arrayOf(At.shape({name:At.string})).isRequired};const Tt="create",_t="edit_users",zt=(e,t=null)=>{const n=Je();return(0,r.useMemo)(()=>t?!!t.userCan[e]:!!n.current_user_can[e],[e,t,n])};function $t(){return!!navigator?.clipboard}var It=n(2470).__,Lt=n(7598);function Ot(e){const{direction:t}=Je(),{setIsDisabled:n}=(0,r.useContext)(Lr),[a,i]=(0,r.useState)(!1),l=zt("delete",e.note),s=zt("edit",e.note),c=e.note.isThread()&&s,p=s||l||e.note.isThread();return(0,r.useEffect)(()=>()=>n(!1),[]),o().createElement(o().Fragment,null,c&&o().createElement(wt,{note:e.note,onLoadingChange:e=>n(e)}),o().createElement(Rt,{readers:e.note.readers}),p&&o().createElement(ae,{modal:!1,dir:t,onOpenChange:e=>{e?window.top.$e.run("notes/open-note-actions"):window.top.$e.run("notes/close-note-actions")}},o().createElement(ae.Trigger,{asChild:!0},o().createElement(R,{name:"eicon-ellipsis-h"})),o().createElement(ae.Content,{align:"end"},e.note.isThread()&&o().createElement(bt,{note:e.note}),s&&o().createElement(ae.Item,{onSelect:()=>e.setIsEditMode(!0),icon:"eicon-edit"},It("Edit","elementor-pro")),e.note.isThread()&&o().createElement(ae.Item,{onSelect:()=>{window.top.$e.run("notes/copy-link",{id:e.note.id})},icon:"eicon-copy",disabled:!$t(),tooltip:!$t()&&It('Supported in "https" sites only',"elementor-pro")},It("Copy Link","elementor-pro")),l&&o().createElement(o().Fragment,null,o().createElement(ae.Separator,null),o().createElement(ae.Item,{onSelect:()=>i(!0),icon:"eicon-trash",variant:"danger"},It("Delete","elementor-pro"))),o().createElement(ae.Arrow,null))),l&&o().createElement(gt,{note:e.note,isOpen:a,onOpenChange:i,onLoadingChange:e=>n(e)}))}Ot.propTypes={note:Lt.instanceOf(Ye).isRequired,setIsEditMode:Lt.func.isRequired};var St=n(7598);const qt=(0,a.Ay)(Se)`
  ...
  ${({autoSize:e})=>e&&a.AH`
	...
	&::after {
	  ...
	  line-height: var(--line-height) !important;
	}`}`,Pt=o().forwardRef(({maxRows:e,autoSize:t,...n},a)=>{const i=(0,r.useRef)();return o().createElement(qt,{maxRows:e,"data-value":n.value||n.defaultValue,autoSize:t,ref:i,disabled:n.disabled},o().createElement("textarea",(0,x.A)({},n,{ref:a,onInput:e=>{n.onInput&&n.onInput(e),i.current.dataset.value=e.target.value}})))});Pt.displayName="Textarea",Pt.propTypes={disabled:St.bool,autoSize:St.bool,maxRows:St.number,onInput:St.func,value:St.string,defaultValue:St.string};const Ft=Pt;const Mt={enabled:!0,params:{}};function Dt(e,t){const n=(0,r.useRef)();return(0,r.useCallback)((...r)=>{clearTimeout(n.current),n.current=setTimeout(()=>{clearTimeout(n.current),e(...r)},t)},[e,t])}const Nt=a.Ay.ul`
	all: revert;
	...
	border-radius: 3px !important;
	box-shadow: 0 1px 20px rgba(0, 0, 0, 0.15) !important;
`;var Ht=n(7598);const Ut=a.Ay.li`
	all: revert;
...
`,Gt=a.Ay.div`
	...
	background: #f1f3f5 !important;
`,Jt=a.Ay.a.attrs(()=>({target:"_blank",rel:"noreferrer"}))`
	color: #6d7882 !important;
	background: #f1f3f5 !important;
	padding: 10px !important;
	display: inline-flex !important;
...
`,mn=a.Ay.span`
	...
	color: #a4afb6 !important;
`,dn=a.Ay.a.attrs(()=>({target:"_blank",rel:"noreferrer"}))`
	all: revert;
...
`;$n.defaultProps={target:"_blank",rel:"noopener noreferrer",className:"elementor-clickable"};const In=$n;var Ln=n(7598);function On(e){return o().createElement(In,{href:e.token.value},e.children)}On.propTypes={children:Ln.node.isRequired,token:Ln.shape({value:Ln.string}).isRequired};var Sn=n(7598);function qn(e){return o().createElement(In,{href:`mailto:${e.token.value}`},e.children)}qn.propTypes={children:Sn.node.isRequired,token:Sn.shape({value:Sn.string}).isRequired};var Pn=n(7598);const Fn=a.i7`
  0% {
	opacity: 1;
...
`;function Dn(e){const[t,n]=(0,r.useState)(!1);return o().createElement(Mn,{isAnimated:t,onMouseEnter:()=>n(!0),onAnimationEnd:()=>n(!1)},e.children)}Dn.propTypes={children:Pn.node.isRequired,token:Pn.shape({value:Pn.string}).isRequired};var Nn=n(7598);const Hn={Paragraph:_n,Mention:zn,Url:On,Email:qn,Wow:Dn,default:({children:e})=>e};function Un(e){const t=(0,r.useMemo)(()=>Hn[e.token.type]||Hn.default,[e.token.type]);return o().createElement(t,{token:e.token},Array.isArray(e.token.value)?e.token.value.map((e,t)=>o().createElement(Un,{token:e,key:t})):e.token.value)}const Vn={};Vn.value=Nn.oneOfType([Nn.string,Nn.arrayOf(Nn.shape(Vn))]),Un.propTypes={token:Nn.shape(Vn)};var Wn=n(7598);const jn=we(),Kn=(0,a.Ay)(Se)`
  ...
  ${({disableInteractions:e})=>e&&a.AH`
	pointer-events: none;
  `};
`;function Qn(e){const t=(0,r.useMemo)(()=>jn.parse(e.children),[e.children]);return o().createElement(Kn,{disableInteractions:e.disableInteractions,className:e.className},t&&o().createElement(Un,{token:t}))}Qn.propTypes={children:Wn.string.isRequired,disableInteractions:Wn.bool,className:Wn.string},Qn.defaultProps={disableInteractions:!1};const Bn=Qn;var Yn=n(2470).__,Zn=n(7598);const Xn=a.Ay.p`
  all: revert;
...
`,Gn=a.Ay.strong`
  font-weight: 500;
`;function Jn(e){const{route:t}=Je(),n=e.note.document?.id===t.post_id,r=e.note.routeUrl===t.url;return!e.note.document||n&&r?null:o().createElement(Xn,null,Yn("Noted on:","elementor-pro")," ",o().createElement(Gn,null,n?e.note.routeTitle:e.note.document.typeTitle))}Jn.propTypes={note:Zn.instanceOf(Ye).isRequired};var er=n(7598);const tr={sm:{text:9},md:{text:12}},nr=(0,a.Ay)(Se)`
...
`,lr=a.Ay.span`
  ...
  ${({size:e})=>e&&a.AH`
	font-size: ${tr[e].text}px !important;
  `};
...
`;function zr(e){const{elements:t}=nt(),n={current:t.get(e.elementId)};return n.current?o().createElement(_r,{containerRef:n,"data-e-notes-portal":!0,position:e.position},e.children):null}zr.propTypes={elementId:Tr.string.isRequired,position:Tr.shape({x:Tr.number.isRequired,y:Tr.number.isRequired}),children:Tr.oneOfType([Tr.node,Tr.arrayOf(Tr.node)])};var $r=n(7598);const Ir=(0,a.Ay)(Se)`
  display: flex !important;
  flex-direction: column !important;
  gap: 28px !important;
...
`,ro=a.Ay.span`
  color: #a4afb6;
  font-size: 11px;
`;function oo(e){return o().createElement(no,null,e.children," ",e.count&&o().createElement(ro,null,"(",e.count,")"))}oo.propTypes={children:to.oneOfType([to.node,to.arrayOf(to.node)]),count:to.number};var ao=n(2470).__;const io=(0,a.Ay)(Se)`
	display: flex !important;
	align-items: center !important;
...
`;function mo(){return o().createElement(io,null,o().createElement("div",null,o().createElement(lo,null,o().createElement(w,{className:"eicon-commenting-o"})),o().createElement(so,null,ao("Share your thoughts with a Note","elementor-pro")),o().createElement(co,null,ao("Select an element on the page to leave a comment, ask a question, etc.","elementor-pro")),o().createElement(po,{href:"https://go.elementor.com/app-notes/",target:"_blank",className:"elementor-clickable"},ao("Learn More","elementor-pro"),o().createElement(w,{className:"eicon-info"}))))}var uo=n(7619);const fo=(0,a.Ay)(i).attrs(()=>({as:uo.Qg}))`
  --font-weight: 600 !important;
  --font-size: inherit !important;
  --font-family: inherit !important;
`,go=(0,a.Ay)(w)`
  color: var( --color ) !important; // Inherited from the <Toast /> component.
`;var ho=n(7598);const yo={default:{background:"#f1f2f3",icon:"#69727d",action:"#69727d"},success:{background:"#e9fbee",icon:"#1d6d38",action:"#1d6d38"},warning:{background:"#fff5e6",icon:"#976402",action:"#976402"},info:{background:"#e6f6ff",icon:"#006bb8",action:"#006bb8"},danger:{background:"#fde8ec",icon:"#b92136",action:"#b92136"}},bo=(0,a.Ay)(uo.y8)`
  display: flex !important;
  gap: 8px !important;
  align-items: center !important;
  width: 100% !important;
  ...
  animation-duration: 400ms !important;
  animation-timing-function: cubic-bezier( 0.16, 1, 0.3, 1 ) !important;
  background-color: ${({variant:e})=>yo[e].background} !important;
	...
	${go} {
	  --color: ${({variant:e})=>yo[e].icon} !important;
	}

	${fo} {
	  --color: ${({variant:e})=>yo[e].icon} !important;
	}
`;bo.propTypes={variant:ho.oneOf(["default","success","warning","info","danger"]).isRequired},bo.defaultProps={variant:"default"};const vo=bo,xo=(0,a.Ay)(uo.Sb)`
	font-weight: bold !important;
`,wo=(0,a.Ay)(uo.aD)`
  font-weight: normal !important;
`,Eo=(0,a.Ay)(i).attrs(()=>({as:uo.eC}))`
...
`,qo=a.Ay.p`
  ...
  margin: 0 !important;
  color: #6d7882 !important;
`;function Po(){return o().createElement(So,null,o().createElement("div",null,o().createElement(qo,{weight:700},Oo("Could not load the panel.","elementor-pro")),o().createElement(qo,null,Oo("Please refresh the page and try again.","elementor-pro"))))}var Fo=n(5835);const Mo=(0,a.Ay)(i).attrs(()=>({as:Fo.bL}))`
  --border-color: #a4afb6;
  --background: #fff;
  --border: 1px solid var( --border-color );
  --border-radius: 3px;
...
`;function No(e){return o().createElement(Mo,e,o().createElement(Do,null,o().createElement(w,{className:"eicon-check"})))}No.propTypes={...Fo.bL.propTypes};var Ho=n(8430);const Uo=(0,a.Ay)(Ho.JU)`
  all: revert;
...
`;var Vo=n(8489);const Wo=(0,a.Ay)(i).attrs(()=>({as:Vo.q7}))`
  --border-color: #a4afb6;
  --background: #fff;
  --border: 1px solid var( --border-color );
  --border-radius: 100%;
...
`;function Ko(e){return o().createElement(Wo,e,o().createElement(jo,null))}Ko.propTypes={...Vo.q7.propTypes},Ko.Group=Vo.z6;var Qo=n(9719);const Bo=(0,a.Ay)(Qo.b)`
  background: #f1f3f5;
...
`;var ba=n(7598);const va=(0,a.Ay)(Se)`
  ...
  ${({isFloating:e})=>e&&a.AH`
  	cursor: move;
  `}
`;function xa(e){const{floating:{active:t,handleClassName:n}}=La();return o().createElement(va,{className:n,isFloating:t},e.children)}xa.propTypes={children:ba.oneOfType([ba.node,ba.arrayOf(ba.node)])};var wa=n(7598);const Ea=(0,a.Ay)(Se)`
  display: flex !important;
  justify-self: ${({align:e})=>e} !important;
`;Ea.propTypes={children:wa.oneOfType([wa.node,wa.arrayOf(wa.node)]),align:wa.oneOf(["start","end"]).isRequired};const Aa=Ea,ka=a.Ay.h3`
	all: revert;
...
`;var Ca=n(7598);const Ra=(0,a.Ay)(Se)`
  position: absolute !important;
  inset: 0 !important;
  ...
  ${({show:e})=>!e&&a.AH`
	...
	pointer-events: none !important;
  `}
`;function Ta(e){return o().createElement(Ra,e,o().createElement(w,{className:"eicon-loading eicon-animation-spin"}))}Ta.propTypes={show:Ca.bool};var _a=n(7598);const za=(0,a.Ay)(Se)`
  display: flex !important;
  flex-direction: column !important;
  background: #e6e9ec !important;
  overflow: hidden !important;
...
`;function Pa(e){const[t,n]=(0,r.useState)(e.isFetching);return Ge(()=>{e.isFetching&&n(!0)},[e.isFetching]),o().createElement(Y,null,o().createElement(Y.Trigger,{asChild:!0},o().createElement(qa,{name:"eicon-sync","data-state":t?"loading":"none",onClick:()=>{window.top.$e.run("notes/refresh-panel"),e.refetch()},onAnimationIteration:()=>{e.isFetching||n(!1)}})),o().createElement(Y.Content,null,Oa("Refresh","elementor-pro"),o().createElement(Y.Arrow,null)))}Pa.propTypes={isFetching:Sa.bool.isRequired,refetch:Sa.func.isRequired};var Fa=n(2470).__;function Ma(){const{direction:e}=Je(),{view:t,setView:n,data:r=[],refetch:a,isSuccess:i,isLoading:l,isFetching:s,isError:c,isNotesView:p,isNotesSummaryView:m}=Jo();return o().createElement(Ia,{isFloating:!0,defaultPosition:{x:"rtl"===e?-50:50,y:50},defaultSize:{width:240,height:400}},o().createElement(Ia.Header,null,o().createElement(Ia.HeaderSideCol,{align:"start"},o().createElement(ra,{view:t,setView:n})),o().createElement(Ia.HeaderTitle,null,Fa("Notes Panel","elementor-pro")),o().createElement(Ia.HeaderSideCol,{align:"end"},o().createElement(Pa,{isFetching:s,refetch:a}),o().createElement(Lo,null))),o().createElement(Ia.Body,null,o().createElement(Ia.Loading,{show:l}),c&&o().createElement(Po,null),i&&p&&o().createElement(Co,{notes:r}),i&&m&&o().createElement($o,{notesSummary:r})),o().createElement(Ia.Footer,null))}var Da=n(5534);const Na=(0,a.Ay)(uo.US)`
  display: flex !important;
  flex-direction: column !important;
  gap: 12px !important;
  position: fixed !important;
